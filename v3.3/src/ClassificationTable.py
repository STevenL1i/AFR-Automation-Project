...
def get_licensepoint():
    ...
    for driver in result:
        ...
        for i in range(2, 2 + race_count):
            ...
            if driver[21] >= 11:
                rank = "excellent"
            elif driver[21] >= 7 and driver[21] <= 10:
                rank = "good"
            elif driver[21] >= 4 and driver[21] <= 6:
                rank = "poor"
            elif driver[21] >= 1 and driver[21] <= 3:
                rank = "danger"
            else:
                rank = "trigger"
            licensepoint.write(row, 2 + race_count, driver[21], formatter.licensepointformat[rank])
