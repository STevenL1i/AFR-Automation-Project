...
for index in range(0,len(raceresult_list)):
    raceresult = raceresult_list[index]
    ...
    for i in range(0,len(result)):
        ...
        if lap[7] == "FINISHED" or lap[7] == "RETIRED":
            ...
            raceresult.write(srow, scol, "QB", defaultformat["qualibanf"])
        elif lap[7] == "DSQ":
            raceresult.write(srow, scol, "DSQ", defaultformat["dsqf"])
        elif lap[7] == "DNS":
            raceresult.write(srow, scol, "DNS", defaultformat["dnsf"])
