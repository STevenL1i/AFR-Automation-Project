...
import upload_newteam as newteam
...
while True:
    print("欢迎来到AFR联赛积分管理系统(AFEC verision) (v6.0)")
    print()
    ...
    print("5.上传新加入车队")   
    print("6.上传车手转会记录")   # checked
    print("7.更新比赛状态")   # checked
    print("8.下载最新积分统计表")   # checked
    print("9.下载最新比赛结算表")   # checked
    print("10.更新排位成绩")   # checked
    print("11.更新正赛成绩")   # checked
    print("12.校准积分")   # checked
    print("13.查看使用说明文档")
    print()
    print("0.退出")
    print()
