...
class format:
    ...
    def __init__(this, workbook):
        ...
        this.driverformat["Red Bull Racing R1"] = redbullf
        this.driverformat["Red Bull Racing R2"] = redbullf
        ...
        this.driverformat["McLaren R1"] = mclarenf
        this.driverformat["McLaren R2"] = mclarenf
        ...
        this.driverformat["Aston Martin R1"] = astonmartinf
        this.driverformat["Aston Martin R2"] = astonmartinf
        ...
        this.driverformat["Alpine R1"] = alpinef
        this.driverformat["Alpine R2"] = alpinef
        ...
        this.driverformat["Alpha Tauri R1"] = alphataurif
        this.driverformat["Alpha Tauri R2"] = alphataurif
        ...
        this.driverformat["Alfa Romeo R1"] = alfaromeof
        this.driverformat["Alfa Romeo R2"] = alfaromeof
        ...
        this.driverformat["Williams R1"] = williamsf
        this.driverformat["Williams R2"] = williamsf
        ...
        this.driverformat["Haas R1"] = haasf
        this.driverformat["Haas R2"] = haasf
        reservef = workbook.add_format({"font_size":11})
        reservef.set_font_name("Dengxian")
        reservef.set_align("vcenter")
        ...
        this.teamformat["Mercedes AMG R1"] = mercedesf
        this.teamformat["Mercedes AMG R2"] = mercedesf
        ferrarif = workbook.add_format({"font_size":11})
        ferrarif.set_bg_color("FF0000")
        ferrarif.set_font_name("Dengxian")
        ferrarif.set_align("vcenter")
        ...
        this.teamformat["Ferrari R1"] = ferrarif
        this.teamformat["Ferrari R2"] = ferrarif
        redbullf = workbook.add_format({"font_size":11})
        redbullf.set_bg_color("#0070C0")
        redbullf.set_font_name("Dengxian")
        redbullf.set_align("vcenter")
        ...
        this.teamformat["Red Bull Racing R1"] = redbullf
        this.teamformat["Red Bull Racing R2"] = redbullf
        mclarenf = workbook.add_format({"font_size":11})
        mclarenf.set_bg_color("#FFC000")
        mclarenf.set_font_name("Dengxian")
        mclarenf.set_align("vcenter")
        ...
        this.teamformat["McLaren R1"] = mclarenf
        this.teamformat["McLaren R2"] = mclarenf
        astonmartinf = workbook.add_format({"font_size":11})
        astonmartinf.set_bg_color("#006633")
        astonmartinf.set_font_name("Dengxian")
        astonmartinf.set_align("vcenter")
        ...
        this.teamformat["Aston Martin R1"] = astonmartinf
        this.teamformat["Aston Martin R2"] = astonmartinf
        alpinef = workbook.add_format({"font_size":11})
        alpinef.set_bg_color("#0080FF")
        alpinef.set_font_name("Dengxian")
        alpinef.set_align("vcenter")
        ...
        this.teamformat["Alpine R1"] = alpinef
        this.teamformat["Alpine R2"] = alpinef
        alphataurif = workbook.add_format({"font_size":11})
        alphataurif.set_bg_color("#00B0F0")
        alphataurif.set_font_name("Dengxian")
        alphataurif.set_align("vcenter")
        ...
        this.teamformat["Alpha Tauri R1"] = alphataurif
        this.teamformat["Alpha Tauri R2"] = alphataurif
        alfaromeof = workbook.add_format({"font_size":11})
        alfaromeof.set_bg_color("#800000")
        alfaromeof.set_font_name("Dengxian")
        alfaromeof.set_align("vcenter")
        ...
        this.teamformat["Alfa Romeo R1"] = alfaromeof
        this.teamformat["Alfa Romeo R2"] = alfaromeof
        williamsf = workbook.add_format({"font_size":11})
        williamsf.set_bg_color("#666699")
        williamsf.set_font_name("Dengxian")
        williamsf.set_align("vcenter")
        ...
        this.teamformat["Williams R1"] = williamsf
        this.teamformat["Williams R2"] = williamsf
        haasf = workbook.add_format({"font_size":11})
        haasf.set_bg_color("BFBFBF")
        haasf.set_font_name("Dengxian")
        haasf.set_align("vcenter")
        ...
        this.teamformat["Haas R1"] = haasf
        this.teamformat["Haas R2"] = haasf
        reservef = workbook.add_format({"font_size":11})
        reservef.set_font_name("Dengxian")
        reservef.set_align("vcenter")
        reservef.set_bg_color("#000000")
